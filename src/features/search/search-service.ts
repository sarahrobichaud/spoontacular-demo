...
import { env } from "../../env";
import type { DetailedRecipe, Recipe, RecipeSearchResponse } from "./search-types";
import type { SearchParams, SearchResults, SearchService, SearchServiceDependencies } from "./search-types";
...
export const searchService = (dependencies: SearchServiceDependencies): SearchService => {
    ...
    return {
        ...
        async search(params: SearchParams): Promise<SearchResults> {
            ...
            return {
                ...
                hasMore: response.offset + response.results.length < response.totalResults
            }
        },
        /**
