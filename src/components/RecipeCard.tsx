...
export function RecipeCard({ recipe }: RecipeCardProps) {
    ...
    <motion.div
      ref={ref}
      className="bg-black/10 hover:bg-black/50 border-2 border-gray-300/10 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow scale-[0.95] hover:scale-[1] transition-transform"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
